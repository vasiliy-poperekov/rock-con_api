    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place_type', models.CharField(blank=True, max_length=32, null=True)),
                ('concert', models.ManyToManyField(blank=True, null=True, related_name='place_concert', to='concert.concert')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_place', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Место',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('social_networks', models.TextField(blank=True, null=True)),
                ('concerts', models.ManyToManyField(blank=True, null=True, related_name='group_concert', to='concert.concert')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_group_singer', to=settings.AUTH_USER_MODEL)),
            ],
            options={
